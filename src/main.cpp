...
unsigned int nStakeMaxAge = 60 * 60;      // 1 Hour
...
const string strMessageMagic = "UCI Signed Message:\n";
...
// Note: 20,000 coins per block for 200 blocks.
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    int64_t nSubsidy = nCoinAge * MAX_MINT_PROOF_OF_STAKE / 365 / COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UCI", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Universal Crowd-Funding Investments creating a new future";
        CTransaction txNew;
        txNew.nTime = 1414705637;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("696b0871b75ae131b8167e2b3cb2368b3d6d1ebda7f6ffc14cb135709e2e0422"));
        block.print();
    ...
    string strPubKey = "04677e84da2c8bb09c28b4d9e9c9115849ac0f3804a5883eef9f706e99e49ac2cc909d43fdac96820fa4ebc94bb18c6c7805adb588897f8e64b2e84b6b12dc6aeb";
...
unsigned char pchMessageStart[4] = { 0x58, 0x55, 0x43, 0x49 };
